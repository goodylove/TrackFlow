// Centralizes dashboard labels, badge styles, initials, and date formatting.
import type { IssuePriority, IssueStatus } from "@/feature/dashboard/types"

export const statusLabels: Record<IssueStatus, string> = { todo: "Todo", in_progress: "In progress", done: "Done" }
export const priorityLabels: Record<IssuePriority, string> = { low: "Low", medium: "Medium", high: "High", urgent: "Urgent" }
